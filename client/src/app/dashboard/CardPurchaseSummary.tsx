    ...
    <div className="flex flex-col justify-between row-span-2 xl:row-span-3 col-span-1 md:col-span-2 xl:col-span-1 bg-white shadow-md rounded-2xl">
      {isLoading ? (
        ...
        <>
          ...
          <div>
            <h2 className="font-semibold text-lg mb-2 px-7 pt-5">Purchase Summary</h2>
            <hr />
          </div>
          ...
          <div>
            <div className="mb-4 mt-7 px-7">
              ...
              <div className="flex items-center">
                <p className="text-2xl font-fold">
                ...
                {lastDataPoint && (
                  <p
                    ...
                    } flex ml-3 gap-1 items-center`}
                  >
                    {lastDataPoint.changePercentage! >= 0 ? <TrendingUp size={20} /> : <TrendingDown size={20} />}
            ...
            <ResponsiveContainer width="100%" height={200} className="p-2">
              <AreaChart data={purchaseData} margin={{ top: 0, right: 0, left: -50, bottom: 45 }}>
                ...
                />
                <Area dataKey="totalPurchased" type="linear" stroke="#8884d8" fill="#8884d8" dot={true} />
              </AreaChart>
            </ResponsiveContainer>
          </div>
        </>
